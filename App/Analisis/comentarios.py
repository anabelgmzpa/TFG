...
# Comentario 3
def coment3(evolucion, ind, tamaño, tipo, ambito, imp, exp, sost, sexo, edad, creencia):
    if evolucion == "Sube":
        valor= "P"
        just= sc.scrap_excel("Positivo", ind, "Energía", tamaño, tipo, ambito, imp, exp, sost, sexo, edad, creencia)
    elif evolucion == "Sube mucho":
        valor= "MP"
        just= sc.scrap_excel("Positivo", ind, "Energía", tamaño, tipo, ambito, imp, exp, sost, sexo, edad, creencia)
    elif evolucion == "Baja":
        valor= "N"
        just= sc.scrap_excel("Negativo", ind, "Energía", tamaño, tipo, ambito, imp, exp, sost, sexo, edad, creencia)
...
# Comentario 4
def coment4(evolucion, ind, tamaño, tipo, ambito, imp, exp, sost, sexo, edad, creencia):
    if evolucion == "Baja":
        valor= "P"
        just= sc.scrap_excel("Positivo", ind, "Energía", tamaño, tipo, ambito, imp, exp, sost, sexo, edad, creencia)
    elif evolucion == "Baja mucho":
